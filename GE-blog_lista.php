...
<head>
    <meta charset="utf-8">
    <title>Blog lista: Grupo de Emprendedores</title>
...
<div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
  <div class="b-inner-page-header__content">
    <div class="container">
      <h1 class="f-primary-l c-default">Blog</h1>
    </div>
  </div>
</div>
                ...
                <a href="blog_detail_left_slidebar.html" class="b-btn f-btn b-btn-light f-btn-light info"><i class="fa fa-link"></i></a>
                        ...
                        <div class="b-infoblock-with-icon b-blog-listing__infoblock">
                            ...
                            <div class="b-infoblock-with-icon__info f-infoblock-with-icon__info">
                                <a href="blog_detail_left_slidebar.html" class="f-infoblock-with-icon__info_title b-infoblock-with-icon__info_title f-primary-l b-title-b-hr f-title-b-hr">
                    ...
                    <div class="b-blog-listing__block">
                        <div class="b-video-player b-blog-listing__block-top">
                            <iframe src="http://player.vimeo.com/video/62542478?title=0&byline=0&portrait=0&badge=0" width="870" height="460" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                        </div>
                        <div class="b-infoblock-with-icon b-blog-listing__infoblock">
                            <a href="#" class="b-infoblock-with-icon__icon f-infoblock-with-icon__icon fade-in-animate hidden-xs">
                            ...
                            <div class="b-infoblock-with-icon__info f-infoblock-with-icon__info">
                                <a href="blog_detail_audio_post.html" class="f-infoblock-with-icon__info_title b-infoblock-with-icon__info_title f-primary-l b-title-b-hr f-title-b-hr">
                                ...
                                <div class="f-infoblock-with-icon__info_text b-infoblock-with-icon__info_text">
                                    <a href="blog_detail_audio_post.html" class="f-more f-primary-b">Read more</a>
                                </div>
                            </div>
                        </div>
                    </div>
