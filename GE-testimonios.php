...
<div class="j-menu-container"></div>
    ...
    <div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
      <div class="b-inner-page-header__content">
        <div class="container">
          <h1 class="f-primary-l c-default">Testimonios</h1>
        </div>
      </div>
    </div>
  ...
  <div class="b-breadcrumbs f-breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li><i class="fa fa-angle-right"></i><span> Testimonio</span></li>
            </ul>
        </div>
    </div>
  ...
  <div class="container">
    ...
    <p class="b-infoblock-description f-desc-section f-center f-employee__desc f-small">Algunos de los Testimonios de Vida de quienes han participado de alguno de nuestros servicios.</p>
             ...
             <div class=" col-xs-12 col-sm-6 col-md-9">
                  <div class="b-news-item f-news-item fade-in-animate bounceInDown">
                  ...
                  <div class="b-news-item f-news-item fade-in-animate ">
                      <div class="hidden-xs b-news-item__img view view-sixth">
                        <img data-retina="" src="img/homepage/news_1.png" alt="">
                        <div class="b-item-hover-action f-center mask">                            
                        </div>
              ...
              <div class="b-form-group col-xs-12 col-sm-6 col-md-3">
              	...
              	<h3 class="f-center f-secondary-l"> <i class="fa fa-wechat"></i><br/> <strong>Dejar un Testimonio</strong>  </h3>
                <h4 class="f-center f-secondary-l"> <i class="fa fa-user"></i><br/> <strong>Identifícate</strong>  </h4>
                  <div class="b-form-row">
                        <input type="text" class="form-control" placeholder="email" />
                    </div>
                    <div class="b-form-row">
                       <input type="text" id="create_account_password" class="form-control" placeholder="Tu Contraseña" />
                    </div>
                    
                    <div class="b-form-row">
                        <textarea class="form-control" placeholder="Mi Testimonio" rows="5"></textarea>
                    </div>
                    <div class="b-form-row">
                        <a href="#" class="b-btn f-btn b-btn-md b-btn-default f-primary-b b-btn__w100">Enviar Testimonio</a>
                    </div>
                    <p><br>No tengo cuenta </p>
                    <a href="GE-registro.php"><button class="button-sm button-gray">Registrarme</button></a>
              </div>
  </div>
</section>
