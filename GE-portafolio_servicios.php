    ...
    <div class="row">
        <div class="col-md-12">
            <div class="b-category-filter b-category-filter--portfolio f-category-filter j-filter">
                <ul>
                    <li class="is-category-filter-active"><a data-filter="all" href="#">Todos</a></li>
                    <?php foreach ($ca as $c){ ?>
                    <li><a data-filter=".<?php echo $c->nombre ?>" href="GE-portafolio_servicios.php?id=<?php echo $c->id ?>"><i class="<?php echo $c->img ?>"></i> <?php echo $c->nombre ?></a></li>
                    <?php } ?>
                </ul>
            </div>
