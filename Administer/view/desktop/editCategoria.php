    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if (empty($nombre) or empty($posicion) or empty($icono)) {
                ...
                $resul = $categoria->update($_GET['id']);
                $param = [
                    'ms' => 'Categoría actualizada exitosamente',
                    'clase' => 'alert-success',
                    'alert' => 'Exito'
                ];
            }
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="card mb-3 mt-1">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <?php
                                        $cat=$categoria->getById($_GET['id']);
                                        ?>
                                        <form id="loginForm" action="editCategoria.php?id=<?php echo $_GET['id'] ?>" method="POST"  class="form-horizontal" >
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group iconos">
                                                        ...
                                                        <input type="radio" class="iconoAct hidden" name="icono" value="<?php echo $cat->img ?>" checked>
                                                ...
                                                <div class="col-md-6 col-md-offset-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="nombre" value="<?php echo $cat->nombre ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-md-offset-3">
                                                    <div class="form-group">
                                                        <label><span class="text-label">*posicion</span></label>
                                                        <input class="form-control" type="text" name="posicion"  value="<?php echo $cat->posicion ?>">
                                                    </div>
                                                </div>
                                            </div>
